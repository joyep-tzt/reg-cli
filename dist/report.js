...
var createHTMLReport = params => {
  ...
  var css = '';
  try {
    js = _fs.default.readFileSync(_path.default.join(__dirname, '../report/ui/dist/report.js'));
    css = _fs.default.readFileSync(_path.default.join(__dirname, '../report/ui/dist/style.css'));
  } catch (e) {
  ...
  var addPercentageInfo = items => {
    return items.map(item => {
      ...
      var diffDetail = params.diffDetails && params.diffDetails[item];
      return {
        raw: item,
        encoded,
        ...(diffDetail && {
...
function createXimdiffWorker(params) {
  ...
  var moduleJs = '';
  try {
    moduleJs = _fs.default.readFileSync(_path.default.join(__dirname, '../report/ui/dist/worker.js'), 'utf8');
  } catch (e) {
